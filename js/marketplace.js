...
(function () {
  ...
  function bindEvents() {
    ...
    if (els.discount) els.discount.addEventListener("change", function () {
      state.discountOnly = els.discount.checked;
      apply();
    });
  ...
  function apply() {
    ...
    if (state.discountOnly) {
      list = list.filter(function (p) { return p.oldPrice && p.oldPrice > p.price; });
    }
  ...
  function resetFilters() {
    ...
    if (els.discount) els.discount.checked = false;
